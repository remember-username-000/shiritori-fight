 ...
 * @returns {Array<Object>} An array of objects that, for each word, contain the object for the word, and the index of the kana reading that matched(as there may be multiple kana readings). If there are no words, the array is empty.
 */
 ...
 * @returns {Array<Object>} An array of objects that, for each word, contain the object for the word, and the index of kana readings 0. If there are no words, the array is empty.
 */
 ...
 * @returns {Array<Object>} An array consisting of one word unit representing a random word from the dictionary.
 */
...
function getWordType (word) {
    if (Object.hasOwn(data_wordTypeList, word.id)) {
        if ((parseInt(data_wordTypeList[word.id], 10) >= 0) && (parseInt(data_wordTypeList[word.id], 10) <= 24)) {
 ...
 * @param {number} typeId The type ID to get the image URL for.
