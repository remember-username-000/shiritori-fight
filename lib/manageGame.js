 ...
 * @param {HTMLElement} originElem The text field to get a new name from.
 * @param {HTMLElement} targetElem The <pre><code>HTMLElement</code></pre> that holds the target player's name display.
