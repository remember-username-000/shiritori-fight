...
function submitWord (wordUnit, disable) {
    ...
    document.getElementById('player-ui-type-preview').innerHTML = "　";
...
function playerSubmit (wordUnit) {
    ...
    document.querySelector(".player-current-word-container.for-you .type-preview").innerHTML = charFromType(getWordType(wordUnit.word));
...
function computerSubmit () {
    ...
    document.querySelector(".player-current-word-container.for-opponent .type-preview").innerHTML = charFromType(getWordType(nextWord.word));
...
function startGame () {
    ...
    document.querySelector(".player-current-word-container.for-you .type-preview").innerHTML = "　";
    ...
    document.querySelector(".player-current-word-container.for-opponent .type-preview").innerHTML = "　";
